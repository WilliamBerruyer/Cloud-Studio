...
<body id="page-top">
        ...
        <div class="container"><a class="navbar-brand js-scroll-trigger" id="CSsites" href="#page-top">CloudStudio</a><button data-toggle="collapse" data-target="#navbarResponsive" class="navbar-toggler navbar-toggler-right" type="button" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><i class="fa fa-align-justify"></i></button>
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" id="pagesSite" href="index.html">Home</a></li>
                    <li class="nav-item"><a class="nav-link" id="pagesSite" href="#">Account</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" id="pagesSite" href="SignUp.html">log out</a></li>
                </ul>
            </div>
        </div>
    </nav>
        ...
        <div class="container"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" id="arianne" href="#">Project Creation</a></li>
                    <li class="nav-item"></li>
                    <li class="nav-item"></li>
                </ul>
            </div>
    ...
    <div>
        <div class="container" id="projectCreation" style="padding: 77px;">
            <div class="row d-xl-flex" id="profilRow">
                <div class="col-md-12 offset-xl-0"><img src="assets/img/Rectangle%2025.png">
                    <p class="profilPic">Marshall Mathers</p><small>Eminem</small>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12" id="ProfilSelecRow2">
                    <p class="ProjectP">Projects</p><small>All your projects</small><button class="btn" id="Plus" type="button"><img src="assets/img/Groupe%2055.png"></button>
                </div>
            </div>
            <form action="../controler/projectCreation.ctrl.php" method="post" required>
              <div>
                <label for="Name">ProjectName :</label>
                <input class="form-control" type="text" name="projectName" placeholder="Project name" minlength="1" maxlength="30" required="">
              </div>
              <div>
                <label>Software Used</label>
                <select class="form-control" name="softwareUsed" required="">
                      <optgroup label="Choose">
                          <option value="1" selected="">Fl Studio</option>
                          <option value="2">Pro Tools</option>
                          <option value="3">Cubase</option>
                          <option value="4">Ableton</option>
                          <option value="5">Studio One</option>
                          <option value="6">Logic Pro X</option>
                      </optgroup>
                  </select>
                  <button class="btn" id="createB" type="submit">Create</button>
              </div>
            </form>
        </div>
    </div>
