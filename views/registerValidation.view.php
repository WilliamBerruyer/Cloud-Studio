...
<body id="page-top">
        ...
        <div class="container"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" id="arianne" href="#">Account Creation</a></li>
                    <li class="nav-item"></li>
                    <li class="nav-item"></li>
                </ul>
            </div>
    ...
    <div class="register-photo">
        <div class="form-container">
            <form action ="connect.ctrl.php" method="post">
                <h2 class="text-center">Your account have been successfully created</h2>
                <!-- <p>"Your account have been successfully created"</p> -->
                <a class="already" href="../controler/login.ctrl.php">Go back to log in page</a>
                <!-- <div class="form-group"><input class="form-control" type="email" name="email" placeholder="Email"></div>
                <div class="form-group"><input class="form-control" type="password" name="password" placeholder="Password"></div>
                <div class="form-group"><button class="btn btn-block btn-lg d-xl-flex justify-content-xl-center" id="btnLoginSignUp" type="submit">Log In</button>
                </div><a class="already" href="../controler/signUp.ctrl.php">Don't have an account ? Sign up here</a> -->
            </form>
